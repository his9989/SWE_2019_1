...
void doTask() {
	...
	while (!is_program_exit) {
		...
		string result = registerAuctionTicket->registerAuctionTickets("2019:05:21:00:00");
		cout << result;
		...
		case 4: {
			...
			case 3: {
				...
				string result = searchAuctionTicketsUI->selectHomeTeam(lineData[2]);
				outFile << result;
...
void setHomeTeams() {
	...
	Ticket * c1 = new Ticket(4000, "2019:05:10:09:00", "doosan", "sk", "L11", true);
	Ticket * c2 = new Ticket(4000, "2019:05:08:18:00", "doosan", "lg", "B50", true);
